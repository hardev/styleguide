...
export default class TeamHeader extends Component {
  ...
  constructor(props) {
    ...
    this.elements = [      
      `
      <!-- Broker Header block -->
      <section class="brokerheader brokerheader__team brokerheader__team__withbackground teambg">
        ...
        <div class="brokerheader__agrow">
        	<div class="brokerheader__agrow__ag">
        		<div class="brokerheader__agrow__ag__ph">
        			<a class="brokerheader__agrow__ag__ph__img withimage" href="#">
  ...
  render() {
    ...
    return (
      <TemplateExpanded
        ...
        <TemplateComponentBlock hasContainer={false} blockTitle="Team Header with photo" elements={this.elements[0]} codeSnippets={this.codeSnippets[0]} />
        <TemplateComponentBlock hasContainer={false} blockTitle="Team Header" elements={this.elements[1]} codeSnippets={this.codeSnippets[1]} />
        <TemplateComponentBlock hasContainer={false} blockTitle="Team Header smaller" elements={this.elements[2]} codeSnippets={this.codeSnippets[2]} />
        <TemplateComponentBlock hasContainer={false} blockTitle="Team Header smaller with less info" elements={this.elements[3]} codeSnippets={this.codeSnippets[3]} />
