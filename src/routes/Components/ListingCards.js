...
export default class ListingCards extends Component {
  ...
  constructor(props) {
    ...
    this.elements = [
      ...
      `<div class="row">
        <div class="col col-12" style="margin-bottom: 0; padding-bottom: 0;">
          <h4 tabindex="0">Listing Card(vertical)</h4>
        </div>
      </div>
  ...
  render(){
    return (
      <TemplateDefault
        ...
        <TemplateComponentBlock blockTitle="Listing Cards(vertical)" elements={this.elements[1]} codeSnippets={this.codeSnippets[1]} />
