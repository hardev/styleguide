    ...
    this.elements = [
      ...
      <div class="row">
        <div class="col col-sm-12 col-12 mb-0 pb-0 ">
          ...
          <!-- card--listing_large -->
          <div class="card card--listing_large">

            <!-- card--listing_large__header -->
            <div class="row no-gutters card--listing_large__header">
              <div class="col-7">
            ...
            <!-- card--listing_large__body -->
	          <div class="card--listing_large__body">
              <a href="#">

                <div class="card--listing_large__body__image_content">
                  <div class="card--listing_large__body__image_content_image" style="background-image: url(https://photos.harstatic.com/153440342/hr/img-1.jpeg?ts=2018-09-13T14:59:06.353);"></div>
                </div>
                <div class="card--listing_large__body__content">
                  <div class="row no-gutters">
  	              ...
  	              <div class="card--listing_large__body__content__description_row">
      ...
      <div class="row">
        <div class="col col-sm-6 col-12 mb-0 pb-0 ">
          ...
          <!-- card--listing_large -->
          <div class="card card--listing_large card--listing_large--portrait">
...
Just need to add the class "card--listing_large--portrait" in the card component
